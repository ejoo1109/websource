...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	//영역 속석에 값 담기 => setAttribute (session.setAttribute / request.setAttribute)
	//영역 속성에 있는 값 가져오기 => getAttribute (session.getAttribute / request.getAttribute)
	//영역 속성에 있는 값 제거 => removeAttribute
	//모든 속성 제거 => invalidate
