...
<form action="modify.do" method="post">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="no" name="no" autofocus value="<%=vo.getNo() %>" readonly>
  </div>
  <div class="form-group">
    <label for="username">이름</label>
    <input type="text" class="form-control" id="username" name="username" value="<%=vo.getUsername() %>" readonly>
  </div>
  <div class="form-group">
    <label for="birthyear">태어난 해</label>
    <input type="text" class="form-control" id="birthyear" name="birthyear" value="<%=vo.getBirthyear() %>" readonly>
  </div>
    <div class="form-group">
